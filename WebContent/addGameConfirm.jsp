...
<title>GameShare: Game add confirm</title>
</head>
<body>
	<!-- barra header fissa -->
	...
	<tr>
		<td align="center" valign="middle">
			Game <b><i><s:property value="name"/></i></b> added!<br>
			Your game now will need approval before it will be published on the site<br>
			You can see it in the game list of the site, below "Games waiting approval"
		</td>
	</tr>
	</table>
</body>
